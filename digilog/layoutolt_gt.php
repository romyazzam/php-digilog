...
include('head.php');
if(!isset($_GET['olt'])){
	$_GET['olt'] = 'GPON01-D5-GSK-3(172.27.140.25)[OLT 2, ZTE]';
} 
?>
			...
			<table style="margin-bottom: 10px;">		
				...
				<div class="col col-24" style="overflow: auto;">
					<table style="font-size: 13px; margin-left: -18px; margin-right: -500px; background-color: white; overflow-y: scroll;" class="table table-bordered table-striped" id="tabel-halaman-layout">
						<thead>
							<th id="color1" style="border-right-width: 10px;"><h4 style="color: white; margin-top: 10px;" align="center">Slot 0</h4></th>
							<th id="color1" style="border-right-width: 10px;" colspan="2"><h4 style="color: white; margin-top: 10px;" align="center">Slot 1</h4></th>
							<th id="color1" style="border-right-width: 10px;"><h4 style="color: white; margin-top: 10px;" align="center">Slot 2</h4></th>
							<th id="color1" style="border-right-width: 10px;" ><h4 style="color: white; margin-top: 10px;" align="center">Slot 3</h4></th>
							<th id="color1" style="border-right-width: 10px;" ><h4 style="color: white; margin-top: 10px;" align="center">Slot 4</h4></th>
							<th id="color1" style="border-right-width: 10px;" ><h4 style="color: white; margin-top: 10px;" align="center">Slot 5</h4></th>
							<th id="color1" style="border-right-width: 10px;" ><h4 style="color: white; margin-top: 10px;" align="center">Slot 6</h4></th>
							<th id="color1" style="border-right-width: 10px;" ><h4 style="color: white; margin-top: 10px;" align="center">Slot 7</h4></th>
							<th id="color1" style="border-right-width: 10px;" ><h4 style="color: white; margin-top: 10px;" align="center">Slot 8</h4></th>
							<th id="color1" style="border-right-width: 10px;" ><h4 style="color: white; margin-top: 10px;" align="center">Slot 9</h4></th>
							<th id="color1" style="border-right-width: 10px;" ><h4 style="color: white; margin-top: 10px;" align="center">Slot 10</h4></th>
							<th id="color1" style="border-right-width: 10px;" ><h4 style="color: white; margin-top: 10px;" align="center">Slot 11</h4></th>
							<th id="color1" style="border-right-width: 10px;" ><h4 style="color: white; margin-top: 10px;" align="center">Slot 12</h4></th>
							<th id="color1" style="border-right-width: 10px;" ><h4 style="color: white; margin-top: 10px;" align="center">Slot 13</h4></th>
							<th id="color1" style="border-right-width: 10px;" ><h4 style="color: white; margin-top: 10px;" align="center">Slot 14</h4></th>
							<th id="color1" style="border-right-width: 10px;" ><h4 style="color: white; margin-top: 10px;" align="center">Slot 15</h4></th>
							<th id="color1" style="border-right-width: 10px;" ><h4 style="color: white; margin-top: 10px;" align="center">Slot 16</h4></th>
		...
		$('#formAddDataOLT').submit(function(event) {
	    	...
	    	$.ajax({
	    		...
	    		success: function(data)
	    		{
					...
					window.location.replace('./layoutolt.php?olt=<?php echo $_GET['olt']; ?>');
				},
