					...
					<div class="modal-body text-dark">
						<div class="row gtr-uniform" >
							...
							<div class="form-group" style="margin-left: -25px; padding-top: 20px;">
								<label for="" style=" margin-bottom: -1px; font-size: 14px;" class="text-dark">Type OLT</label>
								<select disabled style="font-size: 14px; background-color: #e6d6d4;" class="form-control" name="id_olt" id="input-edit-id-olt" aria-describedby="textHelp" required="">
									<option value="" class="text-dark">Select</option>
									<option value="1" class="text-dark">GPON01-D5-GSK-3(172.27.140.25)</option>
									<option value="2" class="text-dark">GPON01-D5-GSK-3(172.27.140.165)</option>
									<option value="3" class="text-dark">GPON02-D5-GSK-3(172.27.141.41)</option>
							...
							<div class="form-group" style="padding-top: 0px; margin-bottom: 0px;">
								<label style=" margin-bottom: -1px; font-size: 14px;" for="" class="text-dark">Port in Slot</label>
								<input style=" font-size: 14px;" style="color: black;" type="text" class="form-control" name="port" id="input-edit-port" aria-describedby="textHelp" placeholder="Enter text" required="" readonly="">
							</div>
...
<!-- 			<div class="col col-24" name="id_col" id="tonggle_column">
				<select>
			...
			<table style="margin-bottom: 10px;">		
				...
				<div class="col col-24" style="overflow: auto;">
					<table style="font-size: 13px; margin-left: -18px; margin-right: -500px; background-color: white;" class="table table-bordered table-striped" id="tabel-layout-olt">
						<thead>
							<th id="color1"><h4 style="color: white; margin-top: 10px;" align="center">Slot 2</h4></th>
							...
							<th id="color1"><h4 style="color: white; margin-top: 10px;" align="center">Slot 7</h4></th>
							<th id="color1"><h4 style="color: white; margin-top: 10px;" align="center">Slot 8</h4></th>
							...
							<th id="color1"><h4 style="color: white; margin-top: 10px;" align="center">Slot 14</h4></th>
							<th id="color1"><h4 style="color: white; margin-top: 10px;" align="center">Slot 15</h4></th>
							<th id="color1"><h4 style="color: white; margin-top: 10px;" align="center">Slot 16</h4></th>
							<th id="color1"><h4 style="color: white; margin-top: 10px; bo" align="center">Slot 17</h4></th>
...
function hideAllColumns () {
	...
	$(document).ready(function(){
	tabel_layout_olt = $('#tabel_layout_olt').DataTable({
			fixedHeader: false,
			scrollY: 500,
			searching: false,
			bInfo: false,
